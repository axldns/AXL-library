package axl.ui
{
	...
	public class ProgressBar extends Sprite implements IprogBar
	{
		...
		public function get BAR_WIDTH():Number { return _BAR_WIDTH }
		public function set BAR_WIDTH(value:Number):void { 
			_BAR_WIDTH = value;
			redraw();
		}

		public function get BAR_HEIGHT():Number { return _BAR_HEIGHT }
		public function set BAR_HEIGHT(value:Number):void {
			_BAR_HEIGHT = value;
			redraw();
		}

		public function get FRAME_COLOR():uint { return _FRAME_COLOR }
		public function set FRAME_COLOR(value:uint):void {
			_FRAME_COLOR = value;
			redraw();
		}

		public function get FRAME_WID():Number { return _FRAME_THICK }
		public function set FRAME_WID(value:Number):void {
			_FRAME_THICK = value;
			redraw();
		}
		
		/** methods to set progress of bar @params bitProgress: 0-1 */
		public function get progess():Number { return _progess }
		...
		public function destroy():void
		{
			...
			this.removeChildren();
			this.graphics.clear();
			if(bar != null)	bar.graphics.clear();
			bar = null;
			if(frame != null) frame.graphics.clear();
			frame = null;
			isBuilded = false;
		}
	}
